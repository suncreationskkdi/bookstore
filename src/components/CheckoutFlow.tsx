        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="bg-slate-50 rounded-lg p-6 space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-600">Shipping ({formData.is_tamil_nadu ? 'Tamil Nadu' : 'Other State'}):</span>
              ...
              <div className="bg-slate-50 rounded-lg p-6">
                ...
                <p className="text-slate-700">{formData.customer_name}</p>
                <p className="text-slate-700">{formData.customer_phone}</p>
                <p className="text-slate-700 mt-2">{formData.shipping_address}</p>
                <p className="text-slate-700">{formData.shipping_state} - {formData.shipping_pincode}</p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-slate-800">Order Placed Successfully!</h3>

              <div className="bg-blue-50 rounded-lg p-6">
                <h4 className="font-semibold text-slate-800 mb-4">Complete Your Payment</h4>
                {settings?.payment_instructions && (
                  <p className="text-slate-700 mb-4">{settings.payment_instructions}</p>
                )}
                ...
                <p className="text-sm text-slate-600 mb-4">
                  Total Amount: <span className="font-bold text-lg">Rs.{totalAmount.toFixed(2)}</span>
                </p>
              </div>
